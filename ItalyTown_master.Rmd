...
sd(xFEtown_town2020_age2020$Estimate.2020)
```
...
x1 <- matrix(c(30950230,29620616,60570846,20499219,21949318,42448537,86133585,85028292,171161877,14699579,16783854,31483433,9374711,13200119,22574830,161657324,166582199,328239523),nrow=6,ncol=3,byrow=TRUE)
USpop[,] <- x1[,]
